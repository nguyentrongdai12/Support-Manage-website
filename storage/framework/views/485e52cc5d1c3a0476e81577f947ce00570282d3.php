    ...
    <?php if(class_exists($options->model)): ?>
        ...
        <?php if($options->type == 'belongsTo'): ?>
            ...
            <?php if(isset($view) && ($view == 'browse' || $view == 'read')): ?>
                ...
                <?php if(isset($query)): ?>
                    <a href="<?php echo e(route('voyager.'.$options->table.'.edit', $relationshipData->{$options->column})); ?>">
...
<?php endif; ?>
<?php /**PATH D:\XAMPP\htdocs\Support Manage\resources\views/vendor/voyager/formfields/relationship.blade.php ENDPATH**/ ?>