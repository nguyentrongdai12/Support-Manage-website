...
<?php $__env->startSection('page_header'); ?>
    <div class="container-fluid">
        ...
        <a href="<?php echo e(setting('admin.github-dainguyen')); ?>" target="_blank" class="btn btn-link pull-right">Link github README.mb</a>
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th>
                                            ...
                                            <?php echo e($row->getTranslatedAttribute('display_name')); ?> <!-- mặc định hiển thị của nó -->
                                            ...
                                            ?>
                                                <td>
                                                    ...
                                                    <?php elseif($row->type == 'select_multiple'): ?>
                                                        ...
                                                        <a href="<?php echo e(route('voyager.'.$dataType->slug.'.show', $data->{$data->getKeyName()})); ?>">
                                                    ...
                                                    <a href="<?php echo e(route('voyager.'.$dataType->slug.'.show', $data->{$data->getKeyName()})); ?>">
                                                        <?php if($data->{$row->field} == 1): ?>
                                                                <span class="label label-info"> <?php echo $row->details->options->{$data->{$row->field}} ?? ''; ?> </span>
                                                            <?php else: ?> 
                                                                <span class="label label-danger"> <?php echo $row->details->options->{$data->{$row->field}} ?? ''; ?> </span>
                                                            <?php endif; ?>
                                                    </a>
                                                    ...
                                                    <?php elseif($row->type == 'checkbox'): ?>
                                                        <?php if(property_exists($row->details, 'on') && property_exists($row->details, 'off')): ?>
                                                            ...
                                                            <a href="<?php echo e(route('voyager.'.$dataType->slug.'.show', $data->{$data->getKeyName()})); ?>">
                                                                <span class="label label-primary"><?php echo e($row->details->on); ?></span>
                                                            </a>
                                                            <?php else: ?>
                                                            <a href="<?php echo e(route('voyager.'.$dataType->slug.'.show', $data->{$data->getKeyName()})); ?>">
                                                                <span class="label label-danger"><?php echo e($row->details->off); ?></span>
                                                            </a>
                                                            <?php endif; ?>
                                                        <?php else: ?>
                                                        <?php echo e($data->{$row->field}); ?>
...
<?php $__env->startSection('javascript'); ?>
    ...
    <script>
        ...
        $('.delete_trash_btn').on('click', function () {
            $('#delete_trash_form')[0].action = '<?php echo e(route('deletetrash', ['table' => $dataType->slug, 'check' => True])); ?>';
...
<?php echo $__env->make('voyager::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\cdbtech\resources\views/vendor/voyager/bread/browse.blade.php ENDPATH**/ ?>